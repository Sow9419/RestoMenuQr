...
export const createProductSchema = z.object({
  ...
  price: z.number().nonnegative({ message: "Le prix doit être supérieur ou égal à 0." }),
...
export const updateProductSchema = z.object({
  ...
  price: z.number().nonnegative({ message: "Le prix doit être supérieur ou égal à 0." }).optional(),
