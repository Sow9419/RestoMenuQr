  ...
  ({ className, hoverable = false, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'bg-white border border-[color:var(--color-border-custom)] rounded-2xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] transition-all duration-150',
          hoverable && 'hover:shadow-md hover:border-[color:var(--color-border-custom)] hover:translate-y-[-1px]',
          className
        )}
        {...props}
      >
